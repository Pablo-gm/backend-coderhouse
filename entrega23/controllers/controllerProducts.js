...
class ProductsController {
    ...
    addProductKoa = async ( ctx ) => {
        let result;
        const {title, price, thumbnail, description, stock, category} = ctx.request.body;
